angular.module('myApp').controller('ListContactosController', ['$http', '$scope', '$location', '$q', '$timeout', '$modal', 'NavigationService', 'EntityUtilService', 'ContactosService', function($http, $scope, $location, $q, $timeout, $modal, NavigationService, EntityUtilService, ContactosService) {
	...
	$scope.add = function () {
		$location.path('/contactos/add');
	};

	$scope.edit = function (obj) {
		$location.path('/contactos/edit/' + obj._id);
	};
	$scope.view = function (obj) {
		$location.path('/contactos/view/' + obj._id);
	};
	$scope.delete = function (obj) {
		$location.path('/contactos/delete/' + obj._id);
	};
	...
	function doDeleteByQuery() {
		...
		return EntityUtilService.deleteByQuery(ContactosService, searchCriteria, $scope.refresh);  		
	}
	...
	function doDeleteSelected() {
		EntityUtilService.deleteSelected(ContactosService, $scope.dataList, $scope.refresh);  
	}
	...
	$scope.importData = function () {
		...
		$location.path('/import/contactos');		
	};
	$scope.exportAs = function (format) { 
		EntityUtilService.exportAsFormat(
			...
			ContactosService, "contactos", $scope);
		$scope.ui.dropdown.isOpen = false;
	};
	//-----------------------------
