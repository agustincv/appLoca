angular.module('myApp').controller('ListUsuariosController', ['$http', '$scope', '$location', '$q', '$timeout', '$modal', 'NavigationService', 'EntityUtilService', 'UsuariosService', function($http, $scope, $location, $q, $timeout, $modal, NavigationService, EntityUtilService, UsuariosService) {
	...
	$scope.view = function (obj) {
		$location.path('/usuarios/view/' + obj._id);
	};
	...
	function doDeleteByQuery() {
		...
		return EntityUtilService.deleteByQuery(UsuariosService, searchCriteria, $scope.refresh);  		
	}
	...
	function doDeleteSelected() {
		EntityUtilService.deleteSelected(UsuariosService, $scope.dataList, $scope.refresh);  
	}
	...
	$scope.exportAs = function (format) { 
		EntityUtilService.exportAsFormat(
			...
			UsuariosService, "usuarios", $scope);
		$scope.ui.dropdown.isOpen = false;
	};
	//-----------------------------
